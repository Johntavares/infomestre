...
const COURSE_JORNADA = [
  ...
  },
  {
    ...
    lessons: [
      ...
      { id: "m2-aula-2", title: "Aula 2 — Atalhos Básicos no Microsoft Word", desc: "Aprenda os 5 atalhos essenciais (Ctrl+Z, Ctrl+C, Ctrl+V, Ctrl+L e Ctrl+A) para editar e organizar documentos com agilidade." },
...
function renderSchoolDashboardTab(container) {
  ...
  container.innerHTML = `
    <div class="school-hub-layout">
      ${window.getTeacherPaymentWarningBannerHtml()}
